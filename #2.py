...
class OptionsWindow(QMainWindow):
    def __init__(self):
        ...
        next_button1.setText("감정 분석")
        next_button1.setIcon(QIcon("C:\ABCDE\Jang\icon.jpg"))
        ...
        next_button2.setText("감정 연습")
        next_button2.setIcon(QIcon("C:\ABCDE\Jang\icon.jpg"))
    ...
    def go_to_emotion_analysis(self):
        self.execute_external_program("C:\ABCDE\Jang\#3-1.py")

    def go_to_expression_practice(self):
        self.execute_external_program("C:\ABCDE\Jang\#3-2.py")

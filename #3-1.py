...
class ProfileWidget(QWidget):
    def __init__(self, parent=None):
        ...
        # Add graph image
        graph_image = QPixmap("C:\ABCDE\Jang\graph.png").scaled(300, 200, Qt.AspectRatioMode.KeepAspectRatio)
...
#detection_model_path = 'C:/ABCDE/Jang/haarcascade_files/haarcascade_frontalface_default.xml'
#emotion_model_path = 'C:/ABCDE/Jang/models/_mini_XCEPTION.102-0.66.hdf5'
